...
\begin{document}
	\begin{tikzpicture}[>=triangle 45]
		...
		\draw[thick] (7.1,-2) -- (7.9,-2);  \draw[thick] (7.1,-1.8) -- (7.1,-2.2); \draw[thick] (7.9,-1.8) -- (7.9,-2.2);
								
		\draw[thick] (11.5,-2) -- (12.3,-2); \draw[thick] (11.5,-1.8) -- (11.5,-2.2); \draw[thick] (12.3,-1.8) -- (12.3,-2.2);
								
		\draw[thick] (12.3,-2) -- (13.1,-2); \draw[thick] (13.1,-1.8) -- (13.1,-2.2);	
	\end{tikzpicture}
\end{document}