...
\begin{document}
	\begin{tikzpicture}[>=triangle 45]
		...
		\draw[thick] (6.4,-2) -- (7.1,-2);  \draw[thick] (6.4,-1.8) -- (6.4,-2.2); \draw[thick] (7.1,-1.8) -- (7.1,-2.2);
								
		\draw[thick] (9.2,-2) -- (10.7,-2); \draw[thick] (9.2,-1.8) -- (9.2,-2.2); \draw[thick] (10.7,-1.8) -- (10.7,-2.2);
								
		\draw[thick] (10.7,-2) -- (12.3,-2);  \draw[thick] (12.3,-1.8) -- (12.3,-2.2);
	\end{tikzpicture}
\end{document}