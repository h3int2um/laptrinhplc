...
\begin{document}
	\begin{tikzpicture}[>=triangle 45]
		...
		\draw[thick] (-1.95,-2) -- (-1.2,-2); \draw[thick] (-1.95,-1.8) -- (-1.95,-2.2); \draw[thick] (-1.2,-1.8) -- (-1.2,-2.2);
								
		\draw[thick] (5.5,-2) -- (7.1,-2);  \draw[thick] (5.5,-1.8) -- (5.5,-2.2); \draw[thick] (7.1,-1.8) -- (7.1,-2.2);
								
		\draw[thick] (7.1,-2) -- (7.9,-2);  \draw[thick] (7.9,-1.8) -- (7.9,-2.2);
	\end{tikzpicture}
\end{document}