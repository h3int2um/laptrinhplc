...
\begin{document}
	\begin{tikzpicture}[>=triangle 45]
		...
		\draw[thick] (-0.4,-2) -- (0.3,-2); \draw[thick] (-0.4,-1.8) -- (-0.4,-2.2); \draw[thick] (0.3,-1.8) -- (0.3,-2.2);
								
		\draw[thick] (5.5,-2) -- (6.4,-2);  \draw[thick] (5.5,-1.8) -- (5.5,-2.2); \draw[thick] (6.4,-1.8) -- (6.4,-2.2);
	\end{tikzpicture}
\end{document}